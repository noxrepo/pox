...
class dbWrapper(QtCore.QThread):
    ...
    def run(self):
        ...
        self.logRecordRcvdSignal.connect(self.handle_rcvd_record)
    ...
    def handle_rcvd_record(self, r):
        ...
        record.setValue(0,str(r.created))
        record.setValue(1,r.name)
        record.setValue(2,r.levelname)
        record.setValue(3,r.msg)
